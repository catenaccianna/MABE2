...
if __name__ == '__main__':
    ...
    #tracer = AvidaTracer(100, 100, False, main_font)
    filename = '../settings/VirtualCPUOrg/example_patch_harvest.org'
    #filename = '../settings/VirtualCPUOrg/ancestor_default.org'
    ...
    #tracer.parse_avida_trace('/media/austin/samsung_nvme_pop/dropbox/msu/Dropbox/Mat_Mining_Experiment/Sample_Results/Rectangular_w_Edges_Environment/grid_1/org-2572919.trace')
    tracer.run()
